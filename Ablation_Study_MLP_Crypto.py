# -*- coding: utf-8 -*-
"""
ABLATION STUDY: MLP ARCHITECTURE ON CRYPTO
===========================================
Extension 1 + 2: Different dataset AND architecture

Architecture: Standard MLP (direct feedforward)
Dataset: Cryptocurrency (15-20 coins)
Configs: mu_only, sigma_only, mu_sigma, mu_random
Seeds: 3

Tests if findings generalize across both datasets and architectures.
"""
...
def main():
    ...
    out_dir = "./ablation_mlp_crypto"  # MLP + CRYPTO  # MLP + STOCKS  # ABLATION  # FAST TEST
