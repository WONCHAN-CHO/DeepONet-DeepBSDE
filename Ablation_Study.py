# -*- coding: utf-8 -*-
"""
ABLATION STUDY: Mu vs Sigma Contribution
=========================================
Auto-generated from Phase2_Fair_Comparison.py

Tests 4 configurations:
  1. mu_only:    Mean predictions only (d features)
  2. sigma_only: Uncertainty only (d features)
  3. mu_sigma:   Both (2d features, current)
  4. mu_random:  Mu + random noise (2d features, control)

Expected results (based on quick test):
  - mu_only ≈ mu_sigma (sigma negligible contribution)
  - sigma_only << mu_only (no mean information)
  - mu_random ≈ mu_sigma (sigma doesn't matter)

Runs: 4 configs × 3 seeds = 12 runs (~1.5 hours)
"""
...
def main():
    ...
    out_dir = "./ablation_results"  # ABLATION  # FAST TEST
