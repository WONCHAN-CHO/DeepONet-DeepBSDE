# -*- coding: utf-8 -*-
"""
ABLATION STUDY: MLP ARCHITECTURE ON STOCKS
===========================================
Extension 2: Different architecture (MLP vs DeepONet)

Architecture: Standard MLP (direct feedforward)
Dataset: 20 stocks (original)
Configs: mu_only, sigma_only, mu_sigma, mu_random
Seeds: 3

Tests if findings generalize across architectures.
"""
...
def main():
    ...
    out_dir = "./ablation_mlp_stocks"  # MLP + STOCKS  # ABLATION  # FAST TEST
