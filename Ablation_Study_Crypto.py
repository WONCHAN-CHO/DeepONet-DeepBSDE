# -*- coding: utf-8 -*-
"""
ABLATION STUDY: CRYPTOCURRENCY DATASET
=======================================
Extension 1: Different asset class (crypto vs stocks)

Same ablation as stocks:
  - mu_only, sigma_only, mu_sigma, mu_random
  - 3 seeds each
  - Same architecture (DeepONet)

Tests if findings generalize across asset classes.
"""
