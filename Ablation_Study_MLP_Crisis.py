# -*- coding: utf-8 -*-
"""
ABLATION STUDY: MLP ARCHITECTURE ON CRISIS PERIOD
==================================================
Extension 1 + 2: Different dataset AND architecture

Architecture: Standard MLP (vs DeepONet)
Dataset: Crisis Period 2008-2012 (vs normal period)
Configs: mu_only, sigma_only, mu_sigma, mu_random
Seeds: 3

Tests generalization across:
  - Architectures: MLP vs DeepONet
  - Market regimes: Crisis vs Normal
"""
...
def main():
    ...
    out_dir = "./ablation_mlp_crisis"  # MLP + CRISIS  # MLP + STOCKS  # ABLATION  # FAST TEST
    ...
    for config_name in config_names:  # ABLATION
        ...
        for lam_tc in lambda_sweep:
            for seed in seeds:
                ...
                model = MLPPolicy(  # MLP ARCHITECTURE
                    trunk_in_dim=2,
